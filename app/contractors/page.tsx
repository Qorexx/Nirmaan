...
const ContractorWorkspacePage: React.FC = () => {
  const { runLiveSimulation, projects } = useEscrowStore();
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          <div className="space-y-2.5 max-w-3xl">
            <div className="flex flex-wrap items-center gap-2.5">
              <Badge pulse variant="emerald" icon={<HardHat className="w-3.5 h-3.5 text-accent-indigo" />}>
              ...
              <Card className="p-0 border border-subtle bg-surface shadow-xl overflow-hidden">
                <div className="p-6 bg-surface border-b border-subtle flex items-center justify-between flex-wrap gap-2">
                  <div>
                    ...
                    <p className="text-xs text-secondary font-mono mt-0.5">Validated against National Infrastructure Governance engineering standards via Zod schema.</p>
                  </div>
                ...
                <form onSubmit={handleSubmit(onSubmitMetadata)} className="p-6 sm:p-8 space-y-6 font-mono text-xs">
                  ...
                  <div className="p-4 rounded-2xl bg-surface border border-accent-indigo/30 flex items-center justify-between flex-wrap gap-4 pt-4 mt-2">
                    <div className="flex items-center gap-2 text-xs text-secondary">
                      ...
                      <span>By submitting, you initiate an instantaneous HTTP 402 AI evaluation ($0.05 USDC verification fee) under National Infrastructure Governance sovereign rules.</span>
                    </div>
            ...
            <div className="space-y-6">
              ...
              <Card className="p-6 bg-surface border border-subtle shadow-xl space-y-6">
                <div className="flex items-center justify-between border-b border-subtle pb-4">
                  ...
                  <Badge pulse variant="emerald" size="sm">ACTIVE PORTAL</Badge>
                </div>
...
export default ContractorWorkspacePage;
