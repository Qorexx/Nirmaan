...
const GovernmentCommandCenterPage: React.FC = () => {
  const { 
    projects, 
    toggleFreezeProject, 
    overrideDecision, 
        ...
        <div className="flex flex-wrap items-center justify-between gap-6 relative z-10">
          <div className="space-y-2 max-w-2xl">
            <div className="flex items-center gap-2">
              <Badge pulse variant="indigo" icon={<ShieldCheck className="w-3.5 h-3.5" />}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card className="border border-subtle space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="amber">₹9.8M LOCKED</Badge>
                </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              <Card className="p-6 border border-subtle space-y-6">
                <div className="flex items-center justify-between border-b border-subtle pb-4">
                  ...
                  <Badge pulse variant="emerald">SYNCED TO LEDGER</Badge>
                </div>
            ...
            <div className="p-4 rounded-2xl bg-surface-secondary border border-rose-500/50 text-rose-200 text-xs flex items-start gap-3">
              ...
              <div className="space-y-1">
                ...
                <p className="opacity-90 leading-relaxed">
                  Executing a manual arbitration override will record your sovereign government signature on the immutable ledger for audit compliance under National Infrastructure Governance regulatory mandates.
                </p>
              </div>
            </div>
...
export default GovernmentCommandCenterPage;
