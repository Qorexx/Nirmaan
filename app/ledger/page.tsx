...
const initialLiveBlocks: LiveBlock[] = [
  ...
  { blockNumber: 19482902, miner: 'Validator-Gov-Master', txCount: 9, gasUsed: '984,200 Gwei', timeAgo: '20s ago', reward: '$0.08 USDC' },
...
const TrustExplorerPage: React.FC = () => {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setLiveBlocks((prev) => {
        ...
        const miners = ['Validator-NHAI-Gov-01', 'Validator-Ministry-04', 'Validator-Gov-Master', 'Validator-Gov-Node'];
          ...
          <div className="space-y-3 max-w-4xl">
            <div className="flex flex-wrap items-center gap-2.5">
              ...
              <span className="text-[11px] font-mono text-accent-emerald font-extrabold bg-emerald-500/10 px-3 py-1 rounded-md border border-emerald-500/30 flex items-center gap-1.5">
                ...
                NETWORK: Gov SOVEREIGN LAYER-1 (1,420 TPS)
              </span>
            </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 bg-surface p-2.5 rounded-2xl border border-subtle shadow-xl">
        <div className="flex items-center gap-2 overflow-x-auto w-full sm:w-auto no-scrollbar">
          {[
            ...
            { id: 'audit' as const, label: '🏛️ Audit Compliance Export Hub', badge: 'Gov READY' },
          ].map((tab) => (
            <button
              key={tab.id}
            ...
            <div className="space-y-6">
              ...
              <Card className="p-6 bg-surface border border-yellow-500/40 shadow-xl space-y-6">
                <div className="flex items-center justify-between border-b border-subtle pb-4">
                  ...
                  <Badge variant="amber" size="sm">Gov LAYER-1</Badge>
                </div>
                ...
                <div className="space-y-4 font-mono text-xs">
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-1">
                    <div className="p-3 rounded-xl bg-surface-secondary border border-subtle space-y-1">
                      ...
                      <strong className="text-primary text-xs block font-sans">Sovereign Gov Layer-1</strong>
                ...
                <div className="h-72 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={latencyChartData}>
                      ...
                      />
                      <ReferenceLine y={100} label={{ value: '100ms Gov Threshold', fill: '#ef4444', fontSize: 10 }} stroke="#ef4444" strokeDasharray="4 4" />
            ...
            <Card className="p-8 bg-surface border border-yellow-500/40 shadow-2xl space-y-6">
              <div className="flex items-center justify-between border-b border-subtle pb-4 flex-wrap gap-4">
                <div>
                  ...
                  <p className="text-xs text-secondary font-mono mt-1">
                    Generate digitally verified Gov inspection logs and cryptographic compliance certificates for national auditing.
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
                <div className="p-6 rounded-2xl bg-surface border border-subtle space-y-4 flex flex-col justify-between">
                  <div className="space-y-2">
                    ...
                    <h4 className="text-base font-extrabold text-primary font-heading">Full Gov Ledger JSON / CSV Export</h4>
...
export default TrustExplorerPage;
